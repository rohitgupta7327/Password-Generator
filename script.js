...
function makePassword(){
    ...
    if(!includeUppercase && !includeLowercase && !includeNumbers && !includeSymbols ){
        alert("Plz select at least one char type");
        return;
    }
...
function updateStrengthMeter(password){
    ...
    // ensure the min score for every short password
    if (passwordLength<8){
    ...
    strengthLabel.textContent="Strength: " + strengthLabelText;
